...
KNOB_REGISTRY_GENERIC_ALLOWLIST="HOME PATH SHELL TMPDIR TMUX TMUX_PANE CMUX_WORKSPACE_ID CLAUDE_PROJECT_DIR CLAUDE_CODE_SESSION_ID XDG_CONFIG_HOME XDG_DATA_HOME XDG_CACHE_HOME XDG_STATE_HOME"
