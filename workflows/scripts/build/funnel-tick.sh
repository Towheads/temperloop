#!/usr/bin/env bash
# funnel-tick.sh — forwarding stub (terminology consolidation v0.17.0,
# temperloop#729). Renamed to pipeline-tick.sh; this stub forwards through
