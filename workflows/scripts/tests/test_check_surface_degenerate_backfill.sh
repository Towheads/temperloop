...
degenerate env:MANDATORY_STEP_REGISTRY_FILE file absent workflows/scripts/validate-mandatory-step-signal.sh "validate-mandatory-step-signal.sh [absent]: exits non-zero, never a silent OK"
degenerate env:MANDATORY_STEP_REGISTRY_FILE file unreadable workflows/scripts/validate-mandatory-step-signal.sh "validate-mandatory-step-signal.sh [unreadable]: exits non-zero, never a silent OK"
degenerate env:MANDATORY_STEP_REGISTRY_FILE file empty workflows/scripts/validate-mandatory-step-signal.sh "validate-mandatory-step-signal.sh [empty]: exits non-zero, never a silent OK"
...
degenerate env:JOIN_KEYS_TSV file absent workflows/scripts/config/check-join-keys.sh "check-join-keys.sh [absent]: exits non-zero, never a silent OK"
degenerate env:JOIN_KEYS_TSV file unreadable workflows/scripts/config/check-join-keys.sh "check-join-keys.sh [unreadable]: exits non-zero, never a silent OK"
degenerate env:JOIN_KEYS_TSV file empty workflows/scripts/config/check-join-keys.sh "check-join-keys.sh [empty]: exits non-zero, never a silent OK"
