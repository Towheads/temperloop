...
# project-agents.sh sources two siblings — gitignore-safety.sh (temperloop#560)
# and project-agents-prune.sh (temperloop#1943) — so a minimal kernel tree must
# carry both or the copied script fails its own "missing sibling script" guard.
cp "${REPO_ROOT}/workflows/scripts/install/gitignore-safety.sh" "${P5}/workflows/scripts/install/gitignore-safety.sh"
cp "${REPO_ROOT}/workflows/scripts/install/project-agents-prune.sh" "${P5}/workflows/scripts/install/project-agents-prune.sh"
