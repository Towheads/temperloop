...
# Design brief: fixture — sanctioned letter-suffixed overlay dimension

Purpose-built passing fixture: all 16 kernel dimensions conformant PLUS a
letter-suffixed overlay-added dimension (`## 16a.`) — the sanctioned overlay
...
## 16a. Org-specific compliance review (overlay-added)
disposition: filled
A letter-suffixed overlay dimension — the sanctioned add-only form.
