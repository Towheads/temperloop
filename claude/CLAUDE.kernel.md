...
| **7** (issues-only, no Projects board) | temperloop (formerly foundation-kernel) | `<org>/temperloop` | — (issues-only backend; `fnd:`-labeled Issues, no Projects-v2 board — see `ISSUES-ONLY-BACKEND.md`) |
