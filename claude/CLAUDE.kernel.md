...
**The board glossary** — three number spaces collide here; this table is canonical: <!-- cite: K.33 incident:F#362 -->
...
**Session-start ritual.** On a board-enabled project, before any work, list the In-Progress set (via the adapter's `worklist`) and ask which to resume — don't pick for the user, and don't start new work until they answer. <!-- cite: K.37 keep:2026-07-25 -->
