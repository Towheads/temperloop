...
- **Compose the spine — do NOT re-orchestrate.** Every mechanic `/fix` needs already exists and is battle-tested; `/fix` is a conversational driver *over* them, not a reimplementation. It reuses, by name: <!-- cite: FX.1 incident:K#13 -->
